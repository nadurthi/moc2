...
plotfolder='simulations/duff2D_meas_treefilter_sim3';
mkdir(plotfolder)
...
%     Xmctest=[];
    ...
    [xfquad,Pfquad]=QuadProp(xfquad,Pfquad,time.dt,time.Tvec(k),model,'ut');
     ...
     priorfullnormpdfkm1 = postfullnormpdf;
    [priorfullnormpdf,postfullnormpdf,Xnptk1_prior,probntk1_prior,Xnptk1_post,probntk1_post]=moc_pf(priorfullnormpdfkm1,k-1,time,NaN,model,struct('genpriorpdf',1,'genpostpdf',0));
...
%             % %%%%%%%%%%%%%%%%% MEAS UPDATE %%%%%%%%%%%%%%%%%%%%%%
%             
%             [priorpdfk1,postpdfk1,Xnptk1_prior,probntk1_prior,Xnptk1_post,probntk1_post]=moc_pf(pdfk,k-1,time,NaN,model,struct('genpriorpdf',1,'genpostpdf',0));
%   
%             
%             xfquadprior=xfquad;
%             Pfquadprior=Pfquad;
...
%             
%             plotpdfs_post_2D(k,priorfullnormpdf,postfullnormpdf,model,Xtruplot,X,probs,xfquad,Pfquad,xfquadprior,Pfquadprior,X_pf, w_pf,X_pfprior,w_pfprior,[],Xmctest,Xtruth(k,:),zk,savePostProps)
%     
%             keyboard
%             % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%             histXpost{k,1}=X;
...
%     plot3Dtreepatches(priorfullnormpdf.boxes)
    ...
    histXprior{k,2}=xfquad;
    histXprior{k,3}=Pfquad;
    histXprior{k,4}=X_pf;
    histXprior{k,5}=w_pf;
