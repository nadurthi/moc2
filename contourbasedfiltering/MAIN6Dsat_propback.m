...
plotfolder='simulations/SAT6Dsim1_props_bringback';
mkdir(plotfolder)
...
%      w_pf=w_pf;
    ...
    [priorfullnormpdf,X,probs] = get_interp_pdf_0I_6D_gobackget(model,priorfullnormpdf,X,probs,4,k,time.Tvec(k),time.dt,Xmctest,Xtruth(k,:));
