function [Xpost_resample,probsXpost_resample,pdfXpostnorm]=MeasUpdt_character_modf_duff(X,probs,pdfnormprior,Nm,Tk,z,Xtruth,model,Xmc,Npts)
...
pdfXpostnorm = get_interp_pdf_0I_duff(Xpost,postprobs,mX,PX,Nm,3,Tk,Xmc,Xtruth);
