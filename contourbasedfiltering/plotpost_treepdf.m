function plotpost_treepdf(k,model,Xtruplot,Xtruth,priorfullnormpdf,postfullnormpdf,Xmctest,Xnptk1_prior,probntk1_prior,Xnptk1_post,probntk1_post,X_pf,w_pf,xfquadprior,Pfquadprior,xfquad,Pfquad,saveprops)
nametag='post';
