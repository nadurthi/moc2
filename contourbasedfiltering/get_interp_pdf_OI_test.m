function [pdf,pdf0Inorm] = get_interp_pdf_OI_test(X,probs,mquad,Pquad,Nm)
dim =size(X,2);
% 
...
cvx_begin
    ...
    minimize( 15*norm(lam2,1)+25*norm(t,2)+100*norm(t2,2))
    subject to
    DD*lam2 <= KK  
    A*lam2==logpn+t
    AAAn*lam2==pppn+t2
