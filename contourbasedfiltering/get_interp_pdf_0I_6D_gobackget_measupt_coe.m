function [priorpdfnorm,postpdfnorm,Xnew,probsnew] = get_interp_pdf_0I_6D_gobackget_measupt_coe(z,model,priorfullnormpdf,Xk1,probsk1,Nm,Tstepk1,Tk1,dtkk1,Xmctest,Xtruth)
...
Xqi=mvnrnd(zeros(dim,1)',(0.8)^2*eye(dim),2000);
% mm=max(max(Xqi));
% Xqi = 1.1*Xqi/mm;
